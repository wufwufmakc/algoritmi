    ...
    <footer style={{ background: "linear-gradient(160deg, hsl(222 47% 9%), hsl(222 40% 14%))" }}>
      <div className="section-container py-20">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="mt-5 flex flex-col gap-4">
              <a href="tel:+78127406604" className="flex items-center gap-3 text-sm transition-colors hover:text-white" style={{ color: "hsl(220 15% 55%)" }}>
                <Phone className="h-4 w-4 shrink-0" />
                8 (812) 740-66-04
              </a>
              <a href="mailto:info@algff.ru" className="flex items-center gap-3 text-sm transition-colors hover:text-white" style={{ color: "hsl(220 15% 55%)" }}>
                <Mail className="h-4 w-4 shrink-0" />
                info@algff.ru
              </a>
              <a href="https://yandex.ru/maps/-/CPGJMAZY" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 text-sm transition-colors hover:text-white" style={{ color: "hsl(220 15% 55%)" }}>
                <MapPin className="h-4 w-4 shrink-0 mt-0.5" />
                <span>Санкт-Петербург, Колпинский район, пос. Петро-Славянка, Софийская ул., 118к5с2, 196642</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-4 sm:flex-row">
          <div className="text-xs" style={{ color: "hsl(220 15% 40%)" }}>
            &copy; {YEAR} Алгоритмы. Фулфилмент-оператор в Санкт-Петербурге.
          </div>
